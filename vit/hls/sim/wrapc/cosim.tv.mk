...
TOOLCHAIN += --sysroot=D:/Xilinx/2025.2/Vitis/tps/mingw/10.0.0/win64.o/nt
...
$(ObjDir)/viterbi_decoder_tb.cpp_pre.cpp.tb.o : viterbi_decoder_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling viterbi_decoder_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/viterbi_decoder.cpp_pre.cpp.tb.o : viterbi_decoder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling viterbi_decoder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bmu.cpp_pre.cpp.tb.o : bmu.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bmu.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++17 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
