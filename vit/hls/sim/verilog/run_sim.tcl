...
if {[file isfile viterbi_decoder.autotvin.dat]} {
	file delete -force viterbi_decoder.autotvin.dat
}

if {[file isfile viterbi_decoder.autotvout.dat]} {
	file delete -force viterbi_decoder.autotvout.dat
}
