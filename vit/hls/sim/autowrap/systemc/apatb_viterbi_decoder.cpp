...
// wrapc file define:
#define AUTOTB_TVIN_encoded_in "../tv/cdatafile/c.viterbi_decoder.autotvin_encoded_in.dat"
#define WRAPC_STREAM_SIZE_IN_encoded_in "../tv/stream_size/stream_size_in_encoded_in.dat"
#define WRAPC_STREAM_INGRESS_STATUS_encoded_in "../tv/stream_size/stream_ingress_status_encoded_in.dat"
#define AUTOTB_TVOUT_decoded_out "../tv/cdatafile/c.viterbi_decoder.autotvout_decoded_out.dat"
#define WRAPC_STREAM_SIZE_OUT_decoded_out "../tv/stream_size/stream_size_out_decoded_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_decoded_out "../tv/stream_size/stream_egress_status_decoded_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_decoded_out "../tv/rtldatafile/rtl.viterbi_decoder.autotvout_decoded_out.dat"
...
extern "C"
void viterbi_decoder_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_viterbi_decoder_hw(void* __xlx_apatb_param_encoded_in, void* __xlx_apatb_param_decoded_out)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "encoded_in",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_encoded_in),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_encoded_in),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_encoded_in),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_encoded_in),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_encoded_in;
  ...
  static hls::sim::Stream<hls::sim::Byte<4>> port1 {
    ...
    .name = "decoded_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_decoded_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_decoded_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_decoded_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_decoded_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_decoded_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    viterbi_decoder_hw_stub_wrapper(__xlx_apatb_param_encoded_in, __xlx_apatb_param_decoded_out);
    port1.buffer();
